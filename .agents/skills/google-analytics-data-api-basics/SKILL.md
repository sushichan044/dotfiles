...
1.  **Enable the API:** Use the Cloud CLI (`gcloud`) to enable
    ...
    _Why: Enabling the API ensures your Cloud project has the necessary quota
    and permissions allocated for running Google Analytics reports._
...
_Why: This configures ADC in your local environment with the required Cloud
Platform and Google Analytics read-only scopes, allowing the client library to
automatically authenticate your requests._
...
- [Python Installation Reference](references/python.md) _(Package:
  `google-analytics-data`)_
...
- [Java Installation Reference](references/java.md) _(Artifact:
  `com.google.cloud:google-cloud-analytics-data`)_
...
- [PHP Installation Reference](references/php.md) _(Package:
  `google/analytics-data`)_
...
- [Node.js Installation Reference](references/nodejs.md) _(Package:
  `@google-analytics/data`)_
...
- [Go Installation Reference](references/go.md) _(Package:
  `cloud.google.com/go/analytics/data/apiv1beta`)_
...
- [.NET Installation Reference](references/dotnet.md) _(Package:
  `Google.Analytics.Data.V1Beta`)_
...
- [Ruby Installation Reference](references/ruby.md) _(Gem:
  `google-analytics-data-v1beta`)_
...
2.  **Run a Report Request:** Below is a complete example demonstrating how to
    ...
    _Why: Using `BetaAnalyticsDataClient` and `RunReportRequest` ensures
