...
- **Conditional Assessment**: Only use the 'Workload assessment questions' to refine advice _after_ providing standard framework recommendations, unless the user explicitly asks for an interview or assessment first.
