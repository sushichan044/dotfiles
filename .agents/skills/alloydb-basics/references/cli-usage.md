...
- **Enable and configure automated scheduled backups:**
  ...
  _Example:_ `--automated-backup-days-of-week=MONDAY,WEDNESDAY,FRIDAY --automated-backup-start-times=01:00 --automated-backup-retention-period=30d`
...
- **Restore to a point in time (PITR):**
  ...
  _Note: TIMESTAMP must be in RFC 3339 format, e.g. `2026-07-30T15:00:00.00Z`._
